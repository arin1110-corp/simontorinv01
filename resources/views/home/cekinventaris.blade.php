        ...
        <div class="main-card">
            ...
            <div class="body-content">
                ...
                <div class="section">
                    ...
                    @php
                        $detailText = $detail->whereNotIn('detail_nama', ['Foto Utama', 'Foto Lainnya']);
                    @endphp
                    ...
                    @forelse($detailText as $d)
                        <div class="attribute-card">
                            ...
                            @if (!empty($d->detail_foto))
                                <img src="{{ asset('asset/atribut_inventaris/' . $d->detail_foto) }}"
                                    class="img-fluid rounded mb-2" style="max-height:220px;">
                            @endif

                            @if (!empty($d->detail_isi))
                    ...
                    <div class="section">
                        ...
                        <div class="gallery">
                            ...
                            @foreach ($gallery as $g)
                                <a href="{{ asset('asset/atribut_inventaris/' . $g->detail_foto) }}" target="_blank">

                                    <img src="{{ asset('asset/atribut_inventaris/' . $g->detail_foto) }}">
